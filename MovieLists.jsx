				...
				return (
					<div key={index} className="flex min-w-fit flex-grow rounded-md bg-white drop-shadow-md">
						...
						<div className="flex flex-grow flex-col justify-between p-2">
							...
							<button
								className="flex w-fit items-center gap-1 self-end rounded-md bg-gradient-to-br from-red-700 to-rose-600 py-1 pl-2 pr-1.5 text-sm font-medium text-red hover:from-red-600 hover:to-rose-500"
